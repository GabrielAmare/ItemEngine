...
Grammar('"bnf"', '"0.0.8"', '" \\n\\t"',
        [Charset('digits', [Str("'0123456789'")]), Charset('letters', [Str("'abcdefghijklmnopqrstuvwxyz'")]),
         ...
         Charset('dq', [Str('\'"\'')]), Pattern('VAR', P_All([Var('alpha'), Var('alphanum')])),
         Operator('P_Inv', All([Str("'~'"), MatchAs('Var', 'arg')])),
         Operator('P_Optional', All([Str("'?'"), MatchAs('P_Inv_', 'arg')])),
         Operator('P_Repeat', All([Str("'*'"), MatchAs('P_Inv_', 'arg')])),
         Operator('P_RepeatP', All([Str("'+'"), MatchAs('P_Inv_', 'arg')])),
         Operator('P_All', EnumP(Str("' '"), MatchIn('P_Skip_', 'args'))),
         Operator('P_Any', EnumP(Str("' | '"), MatchIn('P_All_', 'args'))), Group('P_Atom_', ['Str', 'Var']),
         Group('P_Inv_', ['P_Inv', 'P_Atom_']), Group('P_Skip_', ['P_Optional', 'P_Repeat', 'P_RepeatP', 'P_Inv_']),
         Group('P_All_', ['P_All', 'P_Skip_']), Group('P_Any_', ['P_Any', 'P_All_']),
         ...
         Operator('Pattern', All([Str("'p:'"), MatchAs('VAR', 'name'), Str("' = '"), MatchAs('P_Any_', 'arg')])),
