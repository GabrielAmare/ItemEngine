...
__all__ = ['Any_', 'All_', 'CharsetArg', 'PatternArg', 'GrammarArg', 'Atom_', 'Str', 'Var', 'Match', 'MatchAs', 'MatchIn', 'All', 'Any', 'Optional', 'Repeat', 'Enum', 'EnumP', 'Charset', 'Pattern', 'Operator', 'Group', 'Grammar', 'build']
...
class Pattern:
    def __init__(self, name: VAR, args: List[PatternArg]):
        self.name: VAR = name
